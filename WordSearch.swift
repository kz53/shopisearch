...
//  appFour
//
//  Created by Kelley Zhang on 5/14/19.
...
//    var randX = arc4random(numCols)
//    var randY = arc4random(numRows)
//    return (randX, randY)
//}
//
////sanitize word
...
//
//func getDirection(sect: Int, row: Int, word: String) {
//    var up = [-1, 0]
//    var down = [1, 0]
//    var left = [0, -1]
//    var right = [0, 1]
...
//    for i in 0...wordLen{
//        if(row + i < numCols) {
//            var equalLetters = (checkCellAvailability(word[i] == cardArray[sect*10+row])
//            var isReserved = ()
//            if  () {
//                // do nothing
//            } else {
...
//    for i in 0...wordLen{
//        if(row + i < numCols) {
//            if  (checkCellAvailability(word[i] == cardArray[sect*10+row]) {
//                // do nothing
//                } else {
//                // conflicting letter
//                leftBool = false
